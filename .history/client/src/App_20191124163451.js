...
class App extends Component {
  ...
  getMoviePoster = (searchingText, callback) => {  // 1.
      const url = 'http://img.omdbapi.com/?apikey=5449130e&t' + searchingText; //'https://api.giphy.com' + '/v1/gifs/random?api_key=' + '3KGfvAd3dPojEVRrAjZIBMznHR0PvBwU' + '&tag=' + searchingText;  // 2.
